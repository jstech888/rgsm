...
$item_name = "交易測試(測試)";
//交易返回頁面
$return_url = "http://icodadtest.mooo.com/test/example/Allpay_BACK_Order.php";
//交易通知網址
$client_back_url = "http://icodadtest.mooo.com/test/example/Allpay_BACK_Order.php";

$order_result_url = "http://icodadtest.mooo.com/test/example/Allpay_BACK_Order.php";
//選擇預設付款方式
$choose_payment = "ALL";
//是否需要額外的付款資訊
$needExtraPaidInfo = "Y";
