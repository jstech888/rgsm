...
;(function ($) {
	...
	var fcDefaults = {
		colorize: false,
		region: '',
		roundToDecimalPlace: 0, // roundToDecimalPlace: -2; for not allowing decimals; roundToDecimalPlace: -1; for no rounding; 0 to round to the dollar; 1 for one digit cents; 2 for two digit cents; 3 for three digit cents; ...
