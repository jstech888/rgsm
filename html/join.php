			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumbs list-unstyled list-inline">
						<li class="list-inline-item"><a class="underline" href="index.php">Home</a>
						</li>
						<li class="list-inline-item"><i class="fa fa-angle-double-right"></i>
						</li>
						<li class="list-inline-item">會員登入</li>
					</ul>
				</div>
				<!-- end of col -->
			</div>
				...
				<div class="col-lg-12">
					...
					<form id="StandardForm" data-toggle="validator" data-focus="false">
						<div class="form-group">
							<input type="text" class="form-control-input" id="cusername" required>
							<label class="label-control" for="cusername">E-mail</label>
							<div class="help-block with-errors"></div>
						</div>
						<div class="form-group">
							<input type="password" class="form-control-input" id="cpassword" required>
							<label class="label-control" for="cpassword">Password</label>
							<div class="help-block with-errors"></div>
						</div>
						<div class="form-group">
							<input type="password" class="form-control-input" id="cpassword" required>
							<label class="label-control" for="cpassword">Password confirmation</label>
							<div class="help-block with-errors"></div>
						</div>
						<div class="form-group">
							<input type="password" class="form-control-input" id="cpassword" required>
							<label class="label-control" for="cpassword">Verification code</label>
							<div class="help-block with-errors"></div>
						</div>
						<div class="form-group">
	...
	<div class="footer">
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<p class="p-small text-center">Copyright © Viso - HR Recruiting Landing Page Template by <a class="underline" href="http://www.inovatik.com">Inovatik</a>
						</p>
					</div>
					<!-- end of col -->
				</div>
