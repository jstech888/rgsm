 ...
 * Modified by Jeffrey Lee, 2010-05-21
 * - options.url support Javascript function to provide data
 */
jQuery.autocomplete = function (input, options) {
    ...
    function requestData(q) {
        ...
        //2010-05-22 by Jeffrey, add Javascript function data provider
        if (typeof options.url == "function") {
            var data = options.url(q);
            addToCache(q, data);
            receiveData(q, data);
            return;
        }
    ...
    this.findValue = function () {
        ...
        //2010-05-21 by Jeffrey, for Javascript function data provider
        if (typeof options.url == "function") {
