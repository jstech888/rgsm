...
(function($) {
    ...
    $('body').prepend('<a href="#contact" class="fixed-button page-scroll" style="display: inline;"><i class="fas fa-phone"></i></a>');
    var amountScrolled = 700;
    $(window).scroll(function() {
        if ($(window).scrollTop() > amountScrolled) {
            $('a.fixed-button').fadeIn('500');
        } else {
            $('a.fixed-button').fadeOut('500');
        }
    });
