	...
	{		
		if( $class !== false )
		{
			...
			if( array_key_exists($class, $newAllClass) )
			{
				...
				// $this->data["listAllCatelogProduct"] = array_key_exists($this->page-1, $listStory)? $listStory[$this->page-1]:array();
				...
				$this->load->view('news/_newslist',$this->data);
				// $this->load->view('news/home',$this->data);
		...
		else
		{
			...
			// $this->data["allClassTopFive"] = $this->News_model->allClassTopFive();
			
			// $this->data["hotStory"]  = $this->News_model->classHome( false, 0, 5 );
			...
			$allClass = $this->News_model->allClass();			
			// var_dump($allClass);
			redirect("/news/index/".$allClass[0]['key'],"location","301");
			// $newAllClass = array();
			// $currentClass = array();
			// foreach( $allClass AS $record )
			// {
			...
			// $this->load->view('inc/head',$this->data);
			// $this->load->view('news/homeIndex',$this->data);
			// $this->load->view('inc/footer',$this->data);
		}
	}
