...
// error_log(print_r($dataProduct,true),3,"uploads/log_product_model_queryDetail_dataProduct.log");
		$new_res = array();
		if( count($dataProduct) > 0)
		{
			$new_res = $this->find($dataProduct[0]["id"]);
// error_log(print_r($new_res,true),3,"uploads/log_product_model_queryDetail_new_res.log");			
...
// error_log(print_r($new_res,true),3,"uploads/log_product_model_queryDetail_new_res2.log");
		$this->last_result = $new_res;
		return $this->last_result;
	}
