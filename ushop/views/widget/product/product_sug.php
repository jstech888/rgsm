...
<div class="rec-products-title">
	<span><?php echo "您可能也會喜歡";//$objLang["product"]["promotionProduct"];?></span>
</div>
    ...
    <div class="item product-item">
			<div class="ajax_block_product product_block">
                ...
                <?php if ( $checkStockAryValue  > 0  ) { ?>
                    ...
                    <a class="btn btn-default btn-add-to-cart buy" <?php /*style="background: #e9057b; border: 1px solid #e9057b;"*/?>
                      data-pid="<?php echo $product["PID"];?>" data-formattype="<?php echo $formatType;?>" data-qty="1">                                
                    <?php /*<a
