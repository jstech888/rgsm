          ...
          <div class="addi-products">
            ...
            <div class="addi-pros">
              ...
              <div class="item addi-pro product-item">
                ...
                <select class="quantity btn-selectQty-to-add2 form-control" data-pid="<?php echo $inproduct["PID"];?>">
                <?php 
                  if(is_array($inproduct["stock"])){ 
                ?>
                  <option value="">---</option>
                <?php 
                  }
                  else{
                    $maxNum = $inproduct["stock"]>12? 12:$inproduct["stock"];
                    $i = $maxNum==0? 0:1;
                    for($i;$i<=$maxNum;$i++){ 
                ?>
