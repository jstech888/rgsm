                          ...
                          <div class="left-block">
                            ...
                            <div class="product-item">
                              <div class="image">
                                ...
                                <div class="op">
                                  <?php if( $self !== false ) { ?>
                                    <a class="btn btn-default btn-more-info btn-add-to-watch-list btn-follow-it coll" data-pid="1"> <i class="fa fa-heart" aria-hidden="true"></i> 收藏</a>
                                  <?php }?>
                                  <?php if ( $checkStockAryValue  > 0  ) { ?>
                                    <a class="btn btn-default btn-add-to-cart buy" data-pid="1" data-formattype="<?php echo $formatType;?>" data-qty="1"><i class="fa fa-cart-plus" aria-hidden="true"></i> 直接購買</a>
                                  <?php }?>
                                </div>
                              </div>
                              <div class="title">
