...
<script type="text/javascript" src="/libs/devrama.slider/jquery.devrama.slider.js?t=<?php echo time();?>"></script>
...
<div class="section" style="position: relative;">
		<?php 
			if( count( $HomeSlider ) == 1 )
			{
				...
				$slider = $HomeSlider[$k];
		?>
			<img id="my-slide" src="<?php echo $slider["value"]["image"]["url"];?>" class="img-responsive" style="width:100%" />
		<?php
			}
			else
			{
...
$(function(){
	...
	param.duration 		  = parseInt(param.duration);480
