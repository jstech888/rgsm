        								...
        								<div class="sds_blog_post">
        									<div class="blog_post_ct clearfix">   
        										<div class="news_module_image_holder">
        											 <a href="/News/<?php echo $post["id"];?>"><img alt="<?php echo isset($post["blog-extra"]["alt"])?$post["blog-extra"]["alt"]:"";?>" class="feat_img_small" src="<?php echo $post['blog-extra']["url"];?>"></a>
        										</div>
        										<h4 class="sds_post_title"><a href="/News/<?php echo $post["id"];?>"><?php echo $post["blog-title"];?></a></h4>
        										...
        										<a href="/News/<?php echo $post["id"];?>"  class="r_more btn btn-default"><span><?php echo $functionBar["readMore"];?></span></a>
        									</div>
        								</div>
        								<?php } ?>							
        							</div>
                ...
                <div class="block_content">
                  <div class="video-container">
                    ...
                    <div class="embed-responsive embed-responsive-4by3">
                      <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo isset($SingleVideo[0]["value"]["url"])?$SingleVideo[0]["value"]["url"]:"";?>"></iframe>
                    </div>
                  </div>
                </div>
              </div>
