...
<div class="container">
	<div class="row">
					...
					<div class="slider-item product-item">
						...
						<div class="caption text-left">
							...
							<div class="author-section">
								<img src="<?php echo $class["listArticle"][0]["bloger"]["picture"]["url"];?>" class="img-rounded" />
								<div class="author-name"><?php echo $class["listArticle"][0]["bloger"]["name"];?></div>
								<div class="author-name">|</div>
								<div class="author-name"><?php echo $objLang["bloger"]["message"].$class["listArticle"][0]["msgCount"];?></div>
								<div class="author-name">|</div>
								<div class="author-name touch"><?php echo $objLang["bloger"]["touch"].$class["listArticle"][0]["touch"];?></div>
								<br />
								<div class="panel-time"><?php echo $objLang["bloger"]["postby"];?><?php echo $class["listArticle"][0]["markDate"];?></div>
							</div>
							
							<ul class="list-article">
								<li><img src="/assets/home/dot.png" class="icon-dot" /><a href="/blog/detail/<?php echo $class["listArticle"][1]["id"];?>"><?php echo $class["listArticle"][1]["blog-title"];?></a></li>
								<li><img src="/assets/home/dot.png" class="icon-dot" /><a href="/blog/detail/<?php echo $class["listArticle"][2]["id"];?>"><?php echo $class["listArticle"][2]["blog-title"];?></a></li>
								<li><img src="/assets/home/dot.png" class="icon-dot" /><a href="/blog/detail/<?php echo $class["listArticle"][3]["id"];?>"><?php echo $class["listArticle"][3]["blog-title"];?></a></li>
							</ul>
		...
		<div class="col-md-4">
			<!-- 熱門文章 -->
			<div class="block-title" style="margin-left:0;margin-bottom: 0;margin-right: 0;"><?php echo $objLang["bloger"]["hotNews"];?><!--<a class="btn btn-rounded btn-warning btn-xs pull-right btn-more">更多</a>--></div>
			<?php include_once( VIEWPATH . "widget" . DIRECTORY_SEPARATOR ."blog" . DIRECTORY_SEPARATOR ."articleList.php"); ?>
			<!-- /熱門文章 -->
			
			<!-- 相關部落客 -->
			<div class="block-title" style="margin-left:0;margin-bottom: 0;margin-right: 0;"><?php echo $objLang["bloger"]["relbloger"];?><!--<a class="btn btn-rounded btn-warning btn-xs pull-right btn-more">更多</a>--></div>
