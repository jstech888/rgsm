<div id="columns" class="container self list">
	<div class="row mt25">
		<div class="col-md-12">
			<!-- 麵包屑 -->
			<ol class="breadcrumb">
				<li><a href="/"><?php echo $objLang['shoppingcart']["home"];?><?php /*<span class="glyphicon glyphicon-home" aria-hidden="true"></span>*/?></a></li>
          <?php
            $isAct = "";
            $inds = 1;
            $href = "";
    ...
    <div class="col-md-12">
      <div class="list-banner row">
        <!--大圖輪播-->
        <?php include_once( VIEWPATH . "widget" . DIRECTORY_SEPARATOR ."home" . DIRECTORY_SEPARATOR ."WProductCatelogSlider.php"); ?>
        <?php //include_once( VIEWPATH . "widget" . DIRECTORY_SEPARATOR ."home" . DIRECTORY_SEPARATOR ."WProductSlider.php"); ?>
        <!-- <img src="images/demo/system_banner.jpg"> -->
      </div>
    </div>
...
?>
        ...
        <div class="col-md-3 column left-menu">
          ...
          <?php include_once( VIEWPATH . "widget" . DIRECTORY_SEPARATOR ."product" . DIRECTORY_SEPARATOR ."catelog.php"); ?>
          <?php //include_once( VIEWPATH . "widget" . DIRECTORY_SEPARATOR ."home" . DIRECTORY_SEPARATOR ."catelog.php"); ?>
		...
		<div class="col-md-9 main-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="main title"><?php echo $selfData["name"];?></div>
				</div>
          ...
          ?>
              ...
              <div class="item product-item">
                          ...
                          <?php if ( $checkStockAryValue  == 0  ) { ?>
                            <span class="prod-soldout">已售完</span>
                          <?php }?>
                          ...
                          <img class="img-responsive"
														...
														<div class="op">
															<a
																...
																data-pid="<?php echo $product['PID'];?>"> <i class="fa fa-heart" aria-hidden="true"></i>
																收藏
															</a>

                        <?php if ( $checkStockAryValue  > 0  ) { ?>
                            <a class="btn btn-default btn-add-to-cart buy" data-pid="<?php echo $product["PID"];?>" 
                                data-formattype="<?php echo $formatType;?>" data-qty="1">
                                <i class="fa fa-cart-plus" aria-hidden="true"></i> <?php echo $objLang["product"]["addToCart"];?></a>
                            <?php }?>
                          </div>
													</div>
													<div class="title">
