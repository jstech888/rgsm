					...
					<div class="col-xs-7" id="dvSubscript" style="float:left;">
						<div style="float:left;">
							<div class="subscript-switch text-left">
								<div class="radio">
								  <label><input type="radio" name="subscript" id="subscript1" value="1" checked><?php echo $objLang['profile']["yes"];?></label>
								  <label><input type="radio" name="subscript" id="subscript2" value="2"><?php echo $objLang['profile']["no"];?></label>
								</div>
							</div>							
						</div>
						<div class="clearfix"></div>
...
window.onload = function() {
	...
	$('select[name="subscript"] > option[value="123"]').prop("selected",true).change();
