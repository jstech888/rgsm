										...
										<table class="table table-striped table-hover" id="datatable3" cellspacing="0" width="100%">
											...
											?>
												<tr>
													...
													<td><?php echo $record["detail"]["name"];?></td>
													...
													<td>
														...
														<?php foreach( $record["stock"] AS &$row ) { ?>
															<option><?php echo $row["formatType"]."，數量：".$row["value"];?></option>
														<?php } ?>
														</select>
													</td>
													<?php } else { ?>
													...
													<?php
														...
														$startDate = (empty($flagVar))?date("Y-m-d 00:00:00",strtotime("-7 days")):$flagVar["startDate"];
														$endDate = (empty($flagVar))?date("Y-m-d 23:59:59",strtotime("+7 days")):$flagVar["endDate"];
													?>
													...
													<td>
														<a href="/admin/product/editA?id=<?php echo $record["detailKey"];?>" class="btn btn-success btn-xs">編輯</a>
	...
	function init_MainLangCodeSwitch(){
		$(".main-langCode li a").each(function(){
			...
			$(this).bind("click",function(e){
				location.href = "/admin/product/listTableA?lang="+$(this).attr("data-langCode");
			});
		});
	}
