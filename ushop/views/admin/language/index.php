								...
								<div class="panel-body">
									...
									<div class="panel-body pn">
										<table class="table table-striped table-hover" id="datatable3" cellspacing="0" width="100%">
											...
											?>
												<tr>
													<td><?php echo $record["default_locale"];?></td>
													<td><img src="/libs/images/flags/<?php echo $record["flag"];?>" style="width:30px;"/></td>
													<td class="control-group">
														<?php $isChecked = ( $record["active"] == "1" )?"checked":"";?>
														<div class="switch switch-info switch-inline">
															<input id="langAct-<?php echo $ind;?>" type="checkbox" <?php echo $isChecked;?> onchange="changeAct('<?php echo $record["default_locale"];?>','<?php echo $record["id"];?>',this);" >
