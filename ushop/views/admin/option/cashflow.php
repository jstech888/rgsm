						...
						<div class="panel-body">
							<div class="panel">
								...
								<div class="panel-body">
									...
									<?php 
										if( isset($suntechMerchantParam["web"]) )
										{
											foreach( $suntechMerchantParam["web"] AS $method => $account )
											{
									?>
									<div class="row">
										<label for="web" class="col-sm-6 control-label" style="padding-left: 0;padding-right: 0;"><?php echo $cashflowMethod[$method];?> - 商店帳號</label>
										<div class="col-sm-4">
									...
									?>
									<div class="row">										
										<label for="privateKey" class="col-sm-6 control-label" style="padding-left: 0;padding-right: 0;">金流金鑰</label>
										<div class="col-sm-4">
											<input class="form-control" id="privateKey" value="">
										</div>
									</div>
									<div class="row">
	...
	function init_pageSave()
	{
		...
		$(".page-save").bind("click",function(){
			if(confirm("確定修改？"))
			{
				...
				optionData.push( { "type" : "suntechMerchantParam", "value" : { "web" : webAccount, "privateKey" : $("#privateKey").val() } } );				
