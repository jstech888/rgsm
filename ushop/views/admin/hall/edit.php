    ...
    <div class="tray tray-center p30 pb0 va-t animated-delay"  data-animate="1100">
              ...
              <div class="panel mb30" id="p6">
                ...
                <br>
                  ...
                  <div class=" form-group F-formatType-content formatType-content">
                    ...
                    <?php if($data['hall']['discount_type']==1){  ?>
                      <label style="padding-top: 10px;"> % ( 當折扣類型為 % 時 , 直接設定倍率 例如 : 90% 則為九折)</label>
                    <?php }else{ ?>
                      <label style="padding-top: 10px;"> 元 </label>
                    <?php } ?>
                    <div class="clearfix"></div>
                  </div>
      ...
      <div class="tab-block mb25">
        <ul class="nav nav-tabs tabs-border">
          <li class="active">
            <a href="#tab5_1" data-toggle="tab">促銷優惠簡介</a>
          </li>
        </ul>
      ...
      <div class="tab-block mb25">
            ...
            <div class="panel-footer">
              <div class="pull-right btn-group">
                ...
                <a class="btn btn-default" href="/admin/hall/index">返回</a>
              </div>
              <div class="clearfix"></div>
            </div>
...
<!-- End: Content -->
    ...
    <script type="text/javascript">
        ...
        var hall_detail   = <?php echo json_encode($data["hall"]);?>;
        ...
        jQuery(document).ready(function() {
            ...
            var desc = (typeof(hall_detail['description']) == "undefined")?"":hall_detail['description'];
        ...
        function checkSubmit(){
            ...
            if(!products){
                PM.show({title: "欄位錯誤",text: '請選擇商品',type: "danger"});
                return false;
            }
