...
.list-remove {
  ...
  cursor:pointer;
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-active">
                            <a href="<?php echo base_url("/admin/widget/mainmenu");?>"><?php echo $title;?></a>
                        </li>
                        <li class="crumb-active">
                            <a>編輯</a>
                        </li>
					...
					<div class="panel">
						...
						<div class="panel-body">
								...
								<div class="pull-right mt10">
									...
									<a href="/admin/widget/MainMenu" class="btn btn-default">返回</a>
								</div>
    ...
    <script type="text/javascript">
		refer_uri = "/admin/widget/MainMenu";
		...
		function init_pagesave()
		{
			$(".page-save").click(function(e){
				...
				l.start();
				$.ajax({
					url: "<?php echo base_url('/widget/save/mainmenu');?>",
					async:true,
					cache:false,
					method:"POST",
					data:{
					...
					success:function(data, status, xhr){
						...
						setTimeout(function(){
							location.href = "/admin/widget/MainMenu";
						},500);			
					},
