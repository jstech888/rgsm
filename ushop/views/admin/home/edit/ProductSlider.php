...
#draggable-d-End {
  ...
  top: 550px;
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-active">
                            <a href="<?php echo base_url("/admin/widget/ProductSlider");?>"><?php echo $title;?></a>
                        </li>
                        <li class="crumb-active">
                            <a>編輯</a>
                        </li>
						...
						<div class="panel-body">
							...
							<!-- /upload-prograss-bar -->
									...
									<div class="row">
										<div class="col-xs-12 img-block">
											<div class="draggable-block">
												<img src="<?php echo ( isset($widget["value"]["image"]["url"]) ) ? $widget["value"]["image"]["url"] : "";?>" id="bannerbkimg" class="show-img"/>
										...
										<div class="col-sm-12" style="margin-bottom:15px;margin-top:15px;">
											<div class="form-group">
												<label for="inputTitle" class="col-xs-4 col-md-3 col-lg-1 control-label" style="line-height: 38px;font-size: 20px;margin-bottom: 0;text-align: right;">連結網址</label>
												<div class="col-xs-7 col-md-8 col-lg-10">
													...
													<!--<textarea name="ckeditor2" id="ckeditor2" rows="12">
														<?php echo isset($widget["value"]["caption"]["title"]) ? $widget["value"]["caption"]["title"] :"";?>
													</textarea>-->
												</div>
											</div>
										...
										<!--<div class="col-sm-12" style="margin-bottom:15px;">
											<div class="form-group">
												<label for="inputDescription" class="col-xs-4 col-md-3 col-lg-1 control-label" style="line-height: 38px;font-size: 20px;margin-bottom: 0;text-align: right;">文字區塊2</label>
												<div class="col-xs-7 col-md-8 col-lg-10">
								...
								<div class="pull-right mt10">
									...
									<a href="/admin/widget/ProductSlider" class="btn btn-default">返回</a>
								</div>
    ...
    <script type="text/javascript">
		refer_uri = "/admin/widget/ProductSlider";
        ...
        jQuery(document).ready(function() {
			...
			editorContent = CKEDITOR.replace('ckeditor2', {
                filebrowserBrowseUrl: 		'/admin/vendor/editors/ckfinder/ckfinder.html',
                filebrowserImageBrowseUrl: 	'/admin/vendor/editors/ckfinder/ckfinder.html?type=Images',
                filebrowserFlashBrowseUrl: 	'/admin/vendor/editors/ckfinder/ckfinder.html?type=Flash',
                filebrowserUploadUrl: 		'/admin/vendor/editors/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Files',
			...
			for (var i in CKEDITOR.instances) {
				CKEDITOR.instances[i].on('change', function(evt) {
					...
					if( id == "cke_2" )
					{
						obj_item.value.caption.title = data;
					}
			...
			Img.src = "<?php echo $widget["value"]["image"]["url"];?>"; 
		...
		$('.page-save').click(function(e){
			...
			$.ajax({
				...
				success:function(data, status, xhr){
					...
					setTimeout(function(){
						//location.reload();
						location.href = "/admin/widget/ProductSlider"; 
					},1000);
				},
