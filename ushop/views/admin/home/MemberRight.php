  ...
  vertical-align: middle !important;
            ...
            <header id="topbar">
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="crumb-link">
                            <a href="<?php echo base_url("/admin/widget/MemberRight");?>">會員權益</a>
                        </li>
                    </ol>
                </div>
                ...
                <div class="tray tray-center p30 pb0 va-t animated-delay"  data-animate="1100">
					...
					<div class="panel">
						<div class="panel-heading">
							<!-- title -->
							<h3 class="panel-title text-muted text-center mt10 fw400">會員權益</h3>
							<!-- /title -->
						</div>
									...
									<div class="col-xs-8 br-a br-light bg-light dark va-t p10">
										<div class="row">
											<div class="col-xs-12 text-center">
												<input id="logo-alt" class="form-control" value="" onkeyup="saveTempData('title',this);" />
											</div>
										</div>
									</div>
	...
	function selectMediaStack()
	{
     ...
     jQuery(document).ready(function() {
		...
		*/
		MainLangCode();
		$("#logo-alt").val((typeof(obj_lb[Lang][0].value) == "undefined") ? "" : obj_lb[Lang][0].value.title);
     });
    </script>
    <!-- END: PAGE SCRIPTS -->
	<script type="text/javascript">
