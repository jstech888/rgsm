									...
									<div class="panel-body">
										<div class="row">
											<div class="embed-responsive col-sm-12">
												<iframe id="preview-widget" class="embed-responsive-item" src="/view/show/WHSlider?lang=<?php echo $Lang;?>"></iframe>
											</div>
										</div>
									</div>
								</div>
	...
	function init_MainLangCodeSwitch(){
		$(".main-langCode li a").each(function(){
			...
			$(this).bind("click",function(e){
				location.href = "/admin/widget/HomeSlider?lang="+$(this).attr("data-langCode");
			});
		});
	}
