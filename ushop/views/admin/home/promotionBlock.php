...
.custom-header {
  ...
  padding: 5px 10px;
										...
										<div class="panel-body">
											<div class="tab-block mb25">
												<ul class="nav nav-tabs tabs-border">
													<li class="active">
														<a href="#tab8_1" data-toggle="tab">區塊A</a>
													</li>
													<li>
														<a href="#tab8_2" data-toggle="tab">區塊B</a>
													</li>
													<li>
														<a href="#tab8_3" data-toggle="tab">區塊C</a>
													</li>
												</ul>
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="form-group">
																	<label for="inputStandard" class="col-md-3 control-label">名稱</label>
																	<div class="col-md-8">
																		<input type="text" onkeyup="saveTempData(0,'title',this);" class="form-control" placeholder="<?php echo isset($widget[$langCode][0]['value']['block'][0]['title'])?$widget[$langCode][0]['value']['block'][0]['title']:'';?>">
																	</div>
																</div>
															</div>
															<div class="col-xs-12 mt15">
																...
																<?php	
																	$arr_seleted = isset($widget[$langCode][0]['value']['block'][0]['ids'])?$widget[$langCode][0]['value']['block'][0]['ids']:array();
																	foreach( $produsts AS $row )
																	{
																		if( $row["Shelves"] === false )
																			continue;
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="form-group">
																	<label for="inputStandard" class="col-md-3 control-label">名稱</label>
																	<div class="col-md-8">
																		<input type="text" onkeyup="saveTempData(1,'title',this);" class="form-control" placeholder="<?php echo isset($widget[$langCode][0]['value']['block'][1]['title'])?$widget[$langCode][0]['value']['block'][1]['title']:'';?>">
																	</div>
																</div>
															</div>
															<div class="col-xs-12 mt15">
																...
																<?php	
																	$arr_seleted = isset($widget[$langCode][0]['value']['block'][1]['ids'])?$widget[$langCode][0]['value']['block'][1]['ids']:array();
																	foreach( $produsts AS $row )
																	{
																		if( $row["Shelves"] === false )
																			continue;
														...
														<div class="row">
															<div class="col-xs-12">
																<div class="form-group">
																	<label for="inputStandard" class="col-md-3 control-label">名稱</label>
																	<div class="col-md-8">
																		<input type="text" onkeyup="saveTempData(2,'title',this);" class="form-control" placeholder="<?php echo isset($widget[$langCode][0]['value']['block'][2]['title'])?$widget[$langCode][0]['value']['block'][2]['title']:'';?>">
																	</div>
																</div>
															</div>
															<div class="col-xs-12 mt15">
																...
																<?php	
																	$arr_seleted = isset($widget[$langCode][0]['value']['block'][2]['ids'])?$widget[$langCode][0]['value']['block'][2]['ids']:array();
																	foreach( $produsts AS $row )
																	{
																		if( $row["Shelves"] === false )
																			continue;
	...
	<script type="text/javascript">
		...
		function saveTempData(indx, key, self)
		{
			widget.value.block[indx][key] = $(self).val();
		}
		...
		function init_ProductNavTabs()
		{
			$("#multiSelectHot").multiSelect({				
			  ...
			  selectionHeader: "<div class='custom-header'>區塊A</div>"
			});
			$("#multiSelectFeatures").multiSelect({				
			  selectableHeader: "<div class='custom-header'>產品列表</div>",
			  selectionHeader: "<div class='custom-header'>區塊B</div>"
			});
			$("#multiSelectPromotion").multiSelect({				
			  selectableHeader: "<div class='custom-header'>產品列表</div>",
			  selectionHeader: "<div class='custom-header'>區塊C</div>"
			});
		}
		...
		function selectMediaStack()
		{
			MediaStack.popup({
				selectActionFunction : function(e){
					...
					$("#show-banner").attr("src",file.url);
					
					widget.value.image = file;
				}
			});
		}
		...
		function init_pageSave()
		{
			...
			$(".page-save").bind("click",function(e){
				...
				typeof(widget.value.block[0]) == "undefined" ? widget.value.block[0] = {title: "", ids : ""}:"";
				typeof(widget.value.block[1]) == "undefined" ? widget.value.block[1] = {title: "", ids : ""}:"";
				typeof(widget.value.block[2]) == "undefined" ? widget.value.block[2] = {title: "", ids : ""}:"";
				
				widget.value.block[0].ids = $("#multiSelectHot").val();
				widget.value.block[1].ids = $("#multiSelectFeatures").val();
				widget.value.block[2].ids = $("#multiSelectPromotion").val();
