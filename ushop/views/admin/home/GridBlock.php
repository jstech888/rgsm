...
.grid-container-1113 .grid-block-4 {
  width: 452px;
  height: 406px;
  background-color: #777;
  margin: 5px;
										...
										<div class="row p10">
											<div class="grid-container-1113">
												<div class="grid-block grid-block-1" data-href="<?php echo isset($GridBlock['value'][0]['link'])?$GridBlock['value'][0]['link']:"";?>" style="background-image:url('<?php echo $GridBlock['value'][0]['url'];?>');">
													<div class="alert">建議尺寸：315 x 194</div>
													<div class="tool-box">
												...
												<div class="grid-block grid-block-2" data-href="<?php echo isset($GridBlock['value'][1]['link'])?$GridBlock['value'][1]['link']:"";?>" style="background-image:url('<?php echo $GridBlock['value'][1]['url'];?>');">
													<div class="alert">建議尺寸：262 x 406</div>
													<div class="tool-box">
												...
												<div class="grid-block grid-block-4" data-href="<?php echo isset($GridBlock['value'][3]['link'])?$GridBlock['value'][3]['link']:"";?>" style="background-image:url('<?php echo $GridBlock['value'][3]['url'];?>');">
													<div class="alert">建議尺寸：452 x 406</div>
													<div class="tool-box">
														<div class="btn btn-info" onclick="saveTempData(3,'link');">連結</div>
														<div class="btn btn-warning" onclick="saveTempData(3,'image');">換圖</div>
													</div>
													<div class="link-bar link-bar-3"><?php echo isset($GridBlock['value'][3]['link'])?$GridBlock['value'][3]['link']:"";?></div>
												</div>
