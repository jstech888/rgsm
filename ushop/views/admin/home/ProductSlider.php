...
<body class="editors-page" data-spy="scroll" data-target="#nav-spy" data-offset="300">
									...
									<div class="panel-body">
										<div class="row">
											<div class="embed-responsive col-sm-12">
												<iframe id="preview-widget" class="embed-responsive-item" src="/view/show/WProductSlider?lang=<?php echo $Lang;?>"></iframe>
											</div>
										</div>
									</div>
								</div>
												...
												<div class="dd-content">
														...
														?>
															<div class="row">
																...
																<div class="col-md-4" data-name="caption">
																	<?php echo (isset($slider['value']["caption"]["title"])) ? $slider['value']["caption"]["title"]:"";?>
																</div>
															</div>
														<?php
															}
													...
													<div class="dd-edit pull-right">
														<?php 
															...
															{
														?>
														<a href="/admin/widget/edit/ProductSlider?id=<?php echo $slider['id'];?>" class="dd-edit-config config">
	...
	<script type="text/javascript">
	var preview_src = "<?php echo base_url("view/show/WProductSlider");?>";
	...
	function init_pagesave()
	{
		$('.page-save').click(function(e){
			...
			$.ajax({
				url: "/widget/sortkey/ProductSlider",
				async:true,
				cache:false,
				method:"POST",
				data:postData,
	...
	function init_MainLangCodeSwitch(){
		$(".main-langCode li a").each(function(){
			...
			$(this).bind("click",function(e){
				location.href = "/admin/widget/ProductSlider?lang="+$(this).attr("data-langCode");
			});
		});
	}
