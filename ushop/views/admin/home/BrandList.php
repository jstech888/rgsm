                ...
                <div class="tray tray-center p30 pb0 va-t animated-delay"  data-animate="1100">
					...
					<div class="panel">
						<div class="panel-heading">
							<!-- title -->
							<h3 class="panel-title text-muted text-center mt10 fw400">品牌專區</h3>
							<!-- /title -->
						</div>
							...
							<div class="tabs-content main-tab-content">
								<!-- 表頭圖示 -->
												<div id="editor-listLink" class="tab-pane active">
													...
													<div class="col-lg-12">
														<?php $BrandListAry = $widget[$Lang][0]['value']; 
														foreach ($BrandListAry as $key => $Aobj) 
														{
														?>
														<div class="form-group list-row">
															<label for="title" class="col-lg-1 control-label">
																<span class="glyphicons glyphicons-circle_minus list-remove"></span>品牌</label>
															<div class="col-lg-2">
																<input type="text" class="form-control list-title" value="<?php echo $Aobj['title'];?>" placeholder="title...">
															</div>
															<label for="href" class="col-lg-1 control-label list-content">品牌標籤</label>
															<div class="col-lg-3 list-content">
																<input type="text" class="form-control list-brand" value="<?php echo $Aobj['brand'];?>" placeholder="brand...">
															</div>
															<div class="clearfix"></div>
														</div>
	...
	<div style="display:none;">	
		<div sample="editor-listLink">
			<div class="form-group list-row">
				...
				<label for="href" class="col-lg-1 control-label list-content">品牌標籤</label>
				<div class="col-lg-3 list-content">
					<input type="text" class="form-control list-brand" placeholder="brand...">
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
	...
	function init_pagesave()
	{
		...
		listObject.listLink = {
			init:function(){
				...
				$("#editor-listLink .list-brand").each(function(index, value){
					$(this).attr("data-key",index);
					$(this).unbind("keyup");
					$(this).bind("keyup",function(){
						var val = $(this).val();
						...
						obj_item[Lang][0].value[key].brand = val;
					});
				});
				...
				$("#editor-listLink .add-list-row").bind("click",function(){
					...
					obj_item[Lang][0].value.push({title:"",brand:""});
					parent.init();
				});
