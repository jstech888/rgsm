										...
										<div class="panel-body">
											<div class="row">
												<div class="form-group">
													<label for="videoTitle" class="col-lg-3 control-label">標題</label>
													<div class="col-lg-8">
														<input type="text" id="videoTitle" class="form-control" onkeyup="saveTempData('title', this);" value="<?php echo isset($widget[$langCode][0]['value']['title'])?$widget[$langCode][0]['value']['title']:"";?>">
													</div>
													<div class="clearfix"></div>
												</div>
												<div class="form-group">
													<label for="videoURL" class="col-lg-3 control-label">Youtube 分享代碼 </label>
													<div class="col-lg-8">
														<input type="text" id="videoURL" class="form-control" onkeyup="saveTempData('url', this);" value="<?php echo isset($widget[$langCode][0]['value']['url'])?$widget[$langCode][0]['value']['url']:"";?>">
														<span class="help-block mt5"><i class="fa fa-bell"></i>分享代碼為以下網址紅色部分：https://www.youtube.com/watch?v=<b style="color:red">b09U0KLv6I4</b></span>
													</div>
													<div class="clearfix"></div>
												</div>
											</div>
