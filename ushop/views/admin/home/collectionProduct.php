										...
										<div class="panel-body">
											<div class="row">
												<div class="embed-responsive col-sm-12">
													<iframe id="preview-widget" class="embed-responsive-item" src="/view/show/ProductNavTabs?lang=<?php echo $langCode;?>"></iframe>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="panel-body">
											<div class="tab-block mb25">
												<ul class="nav nav-tabs tabs-border">
													<li class="active">
														<a href="#tab8_1" data-toggle="tab">Hot</a>
													</li>
													<li>
												...
												<div class="tab-content">
													<div id="tab8_1" class="tab-pane active">
														...
														<?php	
															$arr_seleted = explode(",",$widget[$langCode][0]['value']['hot']['ids']);
	...
	<script type="text/javascript">
		...
		function MainLangCode(){
			$(".main-langCode li a").each(function(){
				...
				$(this).bind("click",function(e){
					location.href = "<?php echo base_url("/admin/widget/ProductNavTabs");?>?lang=" + $(this).attr("data-langCode");
				});
			});
		}
		...
		function init_pageSave()
		{
			...
			$(".page-save").bind("click",function(e){
				...
				widget.value.hot.ids = $("#multiSelectHot").val().join();
