...
.custom-header {
  ...
  padding: 5px 10px;
										...
										<div class="panel-body">
											<div class="row">
												<div class="embed-responsive col-sm-12">
													<iframe id="preview-widget" class="embed-responsive-item" src="/view/show/NewsNavTabs?lang=<?php echo $langCode;?>"></iframe>
												</div>
											</div>
										</div>
									</div>
								<!-- /預覽結果 -->
									<div class="panel">
										...
										<div class="panel-body">
											...
											<?php	
												$arr_seleted = $widget[$Lang][0]['value'];
	...
	<script type="text/javascript">
		...
		var widget = <?php echo json_encode($widget);?>;
		...
		function init_pageSave()
		{
			...
			$(".page-save").bind("click",function(e){
				...
				var newVal = $("#hotnews").val();
				widget[Lang][0].value = newVal;
