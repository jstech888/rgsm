									...
									<div class="panel-body">    
										<div class="row">
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" onkeyup="saveMetaData('title',this);" value="<?php echo $meta["value"]["title"];?>" placeholder="">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" onkeyup="saveMetaData('keywords',this);" value="<?php echo $meta["value"]["keywords"];?>" placeholder="">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" onkeyup="saveMetaData('description',this);" value="<?php echo $meta["value"]["description"];?>" placeholder="">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" onkeyup="saveMetaData('author',this);" value="<?php echo $meta["value"]["author"];?>" placeholder="">
												</div>
											</div>
										</div>
									</div>
