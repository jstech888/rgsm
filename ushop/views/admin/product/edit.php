  ...
  display: block;
						...
						<div class="panel-body">
								<div class="panel">
									...
									<div class="panel-body">
                                      ...
                                      <div class="col-sm-12 mb15">
                                        <div class="form-group">
                                          <label for="product-formart-type" class="col-xs-2 control-label">商品屬性</label>
                                          <div class="col-xs-7">
                                            <select id="product-type" class="form-control productType" >
                                              <option value="1" <?php if(@$data_product['type'] ==1)echo 'selected';?> >一般商品</option>
                                              <option value="2" <?php if(@$data_product['type'] ==2)echo 'selected';?>>主題促銷商品</option>
                                              <option value="3" <?php if(@$data_product['type'] ==3)echo 'selected';?>>加購商品</option>
                                            </select>
                                          </div>
                                          <div class="clearfix"></div>
                                        </div>
                                      ...
                                      <div class="clearfix"></div>
										...
										<div class="tabs-content main-tab-content">
											...
											<div class="col-sm-12 mb15">
												<div class="form-group">
													<label for="product-brand" class="col-xs-4 col-md-3 col-lg-2 control-label">品牌</label>
													<div class="col-xs-7 col-md-8 col-lg-9">
														<input id="product-brand" type="text" class="form-control" value="<?php echo htmlspecialchars($data_product['brand'], ENT_QUOTES);?>" onkeyup="saveTempProductData('brand',this);">
													</div>
												</div>
												<div class="clearfix"></div>
											</div>
											...
											<div class="col-sm-12 mb15">
												<div class="form-group">
													...
													<div class="col-xs-7 col-md-8 col-lg-9">
														...
														<span class="help-block mt5"><i class="fa fa-bell"></i> 標籤與標籤間使用半形逗號分隔，例如：<p style="color:red;display:inline-block;">保養,纖體,瘦身</p><p style="color:black;display:inline-block;"> (商品明細頁面'推薦商品'勾稽使用)</span>
													</div>
												</div>
												<div class="clearfix"></div>
											</div>
											...
											<div class="tab-block mb25">
												<ul class="nav nav-tabs">
													...
													<li>
														<a href="#tab5_2" data-toggle="tab">促銷優惠</a>
													</li>
													<li>
														<a href="#tab5_3" data-toggle="tab">滿額免運</a>
													</li>
												</ul>
												<div class="tab-content">
													...
													<div id="tab5_2" class="tab-pane">
														<div class="form-group">
															<label class="col-xs-4 col-md-3 col-lg-2 control-label"></label>
															<div class="col-xs-7 col-md-8 col-lg-9">&nbsp;</div>
															<div class="clearfix"></div>
														</div>
														<div class="col-sm-12 mb15">
															<textarea name="ckeditor6" id="ckeditor6" rows="14">
															<?php echo (isset($data_detail[$DEFAULTLANG]["value"]["description2"]))?$data_detail[$DEFAULTLANG]["value"]["description2"]:"";?>
															</textarea>
															<div class="clearfix"></div>
														</div>
														<div class="clearfix"></div>
													...
													<div id="tab5_3" class="tab-pane">
														...
														<div class="col-sm-12 mb15">
															<textarea name="ckeditor7" id="ckeditor7" rows="14">
															<?php echo (isset($data_detail[$DEFAULTLANG]["value"]["description3"]))?$data_detail[$DEFAULTLANG]["value"]["description3"]:"";?>
															</textarea>
															<div class="clearfix"></div>
														</div>
														<div class="clearfix"></div>
    ...
    <script type="text/javascript">
		...
		function loadTempData()
		{
			...
			var desc6 = (typeof(detail['value']['description2']) == "undefined")?"":detail['value']['description2'];
			CKEDITOR.instances.ckeditor6.setData(desc6);

			var desc7 = (typeof(detail['value']['description3']) == "undefined")?"":detail['value']['description3'];
			CKEDITOR.instances.ckeditor7.setData(desc7);
        ...
        jQuery(document).ready(function() {
            ...
            var editorContent6 = CKEDITOR.replace('ckeditor6', {
                filebrowserBrowseUrl: 		'/admin/vendor/editors/ckfinder/ckfinder.html?type=files',
                height: 400
            });
            var editorContent7 = CKEDITOR.replace('ckeditor7', {
                filebrowserBrowseUrl: 		'/admin/vendor/editors/ckfinder/ckfinder.html?type=files',
                height: 400
            });
			for (var i in CKEDITOR.instances) {
				CKEDITOR.instances[i].on('change', function(evt) {
					...
					if( id == "cke_6" )
					{
						data_detail[lang].value.description2 = evt.editor.getData();
					}
					if( id == "cke_7" )
					{
						data_detail[lang].value.description3 = evt.editor.getData();
					}
...
//TODO
	...
	$(function(){
      ...
      $(".productType").change(function(){
          ...
          data_product['type'] = $(this).val();

          if($(this).val() != 1){
              data_product.parentId = '';
              $("#tree6").hide();
          }else{
              $("#tree6").show();
          }
