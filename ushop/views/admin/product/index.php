					...
					<div class="panel">
						...
						<div class="panel-body">
								...
								<div class="panel-body">
                                  <div class="row ">
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-3 text-right" style="padding-top: 8px;">
                                          ...
                                          <button type="button" onclick="export_excel();" class="btn btn-warning btn-xs pull-left" style="margin-left: 10px;">匯出 商品庫存報表</button>
                                      </div>
                                  </div>
                                </div>
                          ...
                          <td><?php echo @$record["showType"];?></td>
													...
													<?php } ?>
													<td><?php echo $record["normal"];?>元</td>
													<td><?php echo $record["value"];?>元</td>
