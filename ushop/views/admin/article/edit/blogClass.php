...
#cke_1_top {
							...
							<div class="panel" id="spy3">
								<div class="panel-heading">
									<span class="panel-title">
										<span class="glyphicons glyphicons-table"></span>文章分類列表
								...
								<div class="panel-body pn">
									<table class="table table-hover">
										...
										?>
											<tr>
												<td><?php echo $k+1;?></td>
												<td><a href="/blog/index/<?php echo $class["key"];?>">/blog/index/<?php echo $class["key"];?></a></td>
												<td><?php echo (isset($class["value"][$Lang]["title"]))?$class["value"][$Lang]["title"]:"";?></td>
												<td>
													<a class="btn btn-danger btn-xs" href="/admin/blog/blogClass/edit?key=<?php echo $class["key"];?>">編輯</a>
	...
	function del(id)
	{
		if (confirm("確定要刪除？"))
		{
			...
			$.ajax({
				url: "/admin/blog/blogClass/delete",
				async:true,
				cache:false,
				method:"POST",
				data:{ "id" : id },
