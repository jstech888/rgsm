										...
										<table class="table table-striped table-hover" id="datatable3" cellspacing="0" width="100%">
												...
												<tr>
													...
													<td>
														<div class="btn btn-xs btn-default">
															<?php echo $record["class"] == 0 ? "隱藏" : isset($arr_class[$record["class"]]["value"][$Lang]["title"])?$arr_class[$record["class"]]["value"][$Lang]["title"]:$arr_class[$record["class"]]["key"];?>
														</div>
													</td>
													<?php } ?>
											...
											?>
													<td>
														...
														<a target="_blank" href="/<?php echo $article_type;?>/detail/<?php echo $record["id"];?>" class="btn btn-default btn-xs">檢視</a>
														<?php /*<a target="_blank" href="/blog/detail/<?php echo $record["id"];?>" class="btn btn-default btn-xs">檢視</a>*/?>
													</td>
												</tr>
											<?php
												}
